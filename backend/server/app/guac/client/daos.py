...
from server.schema import PydanticModel, kebab_case, to_camel_case

# DAOs = Data Access Objects; the initial data structures used to
# represent data you fetch.


class GuacamoleModel(PydanticModel):
...
class AttributeModel(PydanticModel):
    model_config = ConfigDict(
