...
class PageParams(PydanticModel):
...
async def get_page_params(  # noqa: RUF029
    page_number: PageNumber = Query(default=1),  # noqa: B008
    page_size: PageSize = Query(default=20),  # noqa: B008
) -> PageParams:
