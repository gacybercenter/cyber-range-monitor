...
class ResponseHint(BaseModel):
    ...
    description: Annotated[
        str, Field(..., description="The description of the response")
    ]

    model: Annotated[
        Type[BaseModel], Field(..., description="The pydantic model of the response")
    ]

    headers: Annotated[
        Dict[str, Dict] | None,
        Field(default=None, description="The headers of the response"),
    ]

    title: Annotated[
        str | None, Field(default=None, description="The title of the response")
    ] = None

    status_code: Annotated[
        int,
        Field(
            default=status.HTTP_200_OK, description="The status code of the response"
        ),
    ] = 200
    ...
    def scheme(self) -> Dict:
        ...
        dumped = self.model_dump(exclude={"status_code", "title"}, exclude_none=True)
        return {self.status_code: dumped}
...
def APIResponses(responses: List[Dict]) -> Dict:
