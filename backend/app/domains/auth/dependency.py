...
from app.redis.dependency import RedisClient, redis_client_maker
from app.core.security.oauth import KeyBearerSecurityDep


from .api_key_store import APIKeyStore
from .schemas import ClientIdentity, APIKeyData
from .errors import HTTPApiKeyRequired, HTTPInvalidApiKey
...
RedisAuthDep = Annotated[
    RedisClient, 
    Depends(redis_client_maker('auth:api_key:'))
]
