...
from app.api.error_schema import HttpErrorModel, HttpValidationErrorModel
from app.utils.response_class import MsgSpecJSONResponse
...
class HttpExceptionHandler:
    ...
    def register(cls, app: FastAPI) -> None:
        """
        Registers the exception handler with the FastAPI application.
