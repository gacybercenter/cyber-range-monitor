...
SEED_DATA = {
    ...
    "event_logs": [
        EventLog(log_level=LogLevel.INFO, message="This is an info level log."),
        EventLog(log_level=LogLevel.WARNING, message="This is a warning level log."),
        EventLog(log_level=LogLevel.ERROR, message="This is an error level log."),
        EventLog(log_level=LogLevel.CRITICAL, message="This is a critical level log."),
    ],
}
