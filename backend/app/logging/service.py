...
class LogService(CRUDService[EventLog]):
    ...
    async def get_by_level(self, log_level: LogLevel, limit: Optional[int]) -> list[EventLog]:
    ...
    async def get_query_meta(self, query_filter: QueryFilters, query: Select) -> QueryResultData:
