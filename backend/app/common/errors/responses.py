...
class HTTPErrorSchema(CustomBaseModel):
    ...
    success: Annotated[
        Literal[False], Field(False, description="Explicitly indicates failure")
    ] = False
    status_text: Annotated[str, Field(..., description="The status text of the error")]
...
class HTTPValidationError(HTTPErrorSchema):
    ...
    errors: Annotated[
        ...
        Field(..., description="A list of errors that occurred during validation"),
    ]
