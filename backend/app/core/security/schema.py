...
class ClientUserAgent(CustomBaseModel):
    ...
    user_agent: Annotated[
        str, Field(..., description="The user agent string of the client.")
    ]

    device: Annotated[str, Field(..., description="The device type of the client.")]

    os: Annotated[str, Field(..., description="The operating system of the client.")]

    browser: Annotated[str, Field(..., description="The browser type of the client.")]

    is_bot: Annotated[
        bool, Field(..., description="Whether the client is a bot or not.")
    ]
...
class ClientFingerprint(CustomBaseModel):
    ...
    ip_address: Annotated[str, Field(..., description="The IP address of the client.")]
    user_agent: Annotated[
        ClientUserAgent, Field(..., description="The user agent of the client.")
    ]
