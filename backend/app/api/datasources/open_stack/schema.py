...
class OpenstackOptions(DatasourceOptions):
    ...
    user_domain_name: Annotated[FixedStr, Field(
        ..., description=USER_DOMAIN_NAME_DESC
    )]

    region_name: Annotated[FixedStr, Field(
        ..., description=REGION_NAME_DESC
    )]

    identity_api_version: Annotated[FixedStr, Field(
        ..., description=IDENTITY_API_VERSION_DESC
    )]
...
class OpenstackOptionsUpdate(DatasourceOptions):
    ...
    user_domain_name: Annotated[FixedStr | None, Field(
        default=None, description=USER_DOMAIN_NAME_DESC
    )]

    region_name: Annotated[FixedStr | None, Field(
        default=None, description=REGION_NAME_DESC
    )]

    identity_api_version: Annotated[FixedStr | None, Field(
        default=None, description=IDENTITY_API_VERSION_DESC
    )]
...
class OpenstackUpdateBody(DatasourceUpdateBody):
    ...
    options: Annotated[OpenstackOptionsUpdate | None, Field(
        None, description=options_desc('openstack')
    )]
