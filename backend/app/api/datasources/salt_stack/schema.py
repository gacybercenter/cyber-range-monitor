...
Hostname = Annotated[FixedStr, Field(
...
class SaltstackOptionsUpdate(DatasourceOptions):
    ...
    hostname: Annotated[FixedStr | None, Field(
        None,
        description="The hostname of the saltstack datasource."
    )]


SaltStackOpts = Annotated[SaltstackOptions, Field(
    ...,
    description=options_desc('saltstack')
)]
...
class SaltstackListResponse(DatasourceList):
    ...
    data: Annotated[List[SaltstackResponse], Field(
        ...,
        description="The list of saltstack datasources"
    )]
