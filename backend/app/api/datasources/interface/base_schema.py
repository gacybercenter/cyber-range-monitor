...
DSUsername = Annotated[
    FixedStr, Field(..., description="The username of the datasource")
]
DSPassword = Annotated[
    FixedStr, Field(..., description="The password of the datasource")
]
DSEndpoint = Annotated[
    FixedStr, Field(..., description="The endpoint of the datasource")
]
...
class DatasourceSchema(ResponseSchema):
    ...
    enabled: Annotated[
        bool, Field(..., description="Whether the datasource is enabled or not")
    ]
    username: DSUsername
    endpoint: DSEndpoint
...
class DatasourceAuthUpdate(RequestSchema):
    ...
    username: Annotated[
        FixedStr | None,
        Field(default=None, description="The username of the datasource"),
    ]

    password: Annotated[
        FixedStr | None,
        Field(default=None, description="The password of the datasource"),
    ]

    endpoint: Annotated[
        FixedStr | None,
        Field(default=None, description="The endpoint of the datasource"),
    ]
...
class DatasourceList(ResponseList):
    data: Annotated[
        List[DatasourceResponse], Field(..., description="The list of datasources")
    ]
...
class DatasourceUpdateBody(DatasourceBodyMixin):
    ...
    options: Annotated[
        DatasourceOptions | None,
        Field(
            default=None, description="The custom / unique options for the datasource"
        ),
    ]
...
class ConnectionTestResults(ResponseSchema):
    message: Annotated[
        FixedStr, Field(..., description="The message of the connection test")
    ]
    success: Annotated[
        bool,
