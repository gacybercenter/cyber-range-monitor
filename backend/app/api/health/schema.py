...
class RedisConnectionParams(ResponseSchema):
    ...
    client_id: Annotated[Any | None, Field(
        None,
        description="Redis client ID if available"
    )]
...
class RedisHealthResponse(ResponseSchema):
    ...
    last_checked_at: Annotated[datetime, Field(
