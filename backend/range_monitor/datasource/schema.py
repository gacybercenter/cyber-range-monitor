...
from range_monitor.schema import RequestBody, ResponseModel
...
DatasourceCategoryName = Annotated[
    DatasourceCategory,
    Field(
        ...,
        description='The category/type of the datasource',
    )
]
...
class DatasourceSchema(ResponseModel):
    id: DatasourceID
    category: DatasourceCategoryName
