...
from .openapi_extra import api_error, create_operation_id
...
auth_protected_errors = {
    status.HTTP_401_UNAUTHORIZED: api_error('User not authenticated'),
    status.HTTP_403_FORBIDDEN: api_error('User does not have permission'),
}
