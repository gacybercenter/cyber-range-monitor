...
from monitor_api.db.dependency import DatabaseDep
from monitor_api.app.openapi_extra import (
    APIResponses,
    ErrorDoc,
    UserAuthErrors,
    NotFound,
...
from monitor_api.common.schemas.http import MessagedResponse
from monitor_api.domain.users.dependency import RoleRequired, UserRequired, AdminRequired

from fastapi import APIRouter, Body, Depends, Security, status

from monitor_api.common.types import PathID
