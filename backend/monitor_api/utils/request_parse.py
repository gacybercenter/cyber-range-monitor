...
class RequestTelemetry:
    ...
    @staticmethod
    def audit_request(request: Request) -> RequestRecord:
        '''
        ...
        ip_address = RequestTelemetry.get_request_ip(request)
        user_agent = RequestTelemetry.collect_user_agent(request)
