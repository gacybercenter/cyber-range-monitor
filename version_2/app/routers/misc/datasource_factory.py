...
def create_data_source_router(
    ...
    async def create_datasource(create_ds_schema: create_schema, db: DatabaseRequired) -> read_schema:
    ...
    async def get_datasource(datasource_id: int, db: DatabaseRequired) -> read_schema:
