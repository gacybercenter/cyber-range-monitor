...
//  * @property {string} parentIdentifierentifier - Identifier of the parent node.
...
//     this.parentIdentifierentifier = rawJson.parentIdentifierentifier;
...
//   parent() {
//     return this.parentIdentifierentifier;
//   }
...
//    */
//   addEdge(node) {
//     if (node.parentIdentifierentifier !== this.identifier) {
...
//    * @returns {void}
//    */
//   buildGroupTopology(parentIdentifier) {
//     const connGroup = this.getNode(parentIdentifier);

//     if (!connGroup) return false;

//     const children = this.filterBy((node) => node.parent() === parentIdentifier);
