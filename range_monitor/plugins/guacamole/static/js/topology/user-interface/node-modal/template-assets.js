...
export class Checkbox {
	...
	init() {
		...
		this.$tag.data(dataField, dataValue).attr("id", this.id);
    ...
    */
	...
	check() {
		...
		this.$icon.removeClass("far fa-square").addClass("fas fa-check-square");
	}
	uncheck() {
		this.$tag.removeClass("selected");
		this.$icon.removeClass("fas fa-check-square").addClass("far fa-square");
	}
	isChecked() {
