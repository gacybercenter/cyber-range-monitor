fetch('/api/topology_data')
    ...
    .then(data => {
        ...
        nodes.forEach(node => {
            node.data = removeNullNumericValues(node);
...
function removeNullNumericValues(obj) {
    ...
    for (let key in objCopy) {
        if (objCopy[key] === null || objCopy[key] === '') {
            ...
            objCopy[key] = removeNullNumericValues(objCopy[key]); // Recursively call the function for nested objects
